    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="bg-white shadow">
            <div class="container mx-auto">
                <div class="flex space-x-4">
                    <button id="tab-menu" class="py-4 px-6 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-blue-500">Menu</button>
                    <button id="tab-achievements" class="hidden py-4 px-6 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-blue-500">Achievements</button>
                    <button id="tab-marks" class="hidden py-4 px-6 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-blue-500">Marks</button>
                    <button id="tab-items" class="hidden py-4 px-6 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-blue-500">Items</button>
                    <button id="tab-challenges" class="hidden py-4 px-6 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-blue-500">Challenges</button>
                    <button id="tab-bestiary" class="hidden py-4 px-6 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-blue-500">Bestiary</button>
                    <button id="tab-others" class="hidden py-4 px-6 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-blue-500">Others</button>
                </div>
            </div>
        </div>
        ...
        <div class="flex-grow container mx-auto p-4">
            <div id="content-menu" class="tab-content hidden">
                <h2 class="text-2xl font-bold mb-4">Contenu Onglet 1</h2>
                <div class="wrapper flex flex-wrap flex-col">
                    <button id="download-button">Download</button>
                    <input id="upload-button" type="file" accept=".dat">
                </div>
            </div>
            ...
            <div id="content-marks" class="tab-content flex flex-col hidden">
                <div class="flex items-center">
                    ...
                    <button id="toggle-online-marks" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Toggle all online marks</button>
                </div>
